...
interface IDecisionTableProps {
  data: DecisionTableModel;
}

@observer
// tslint:disable-next-line:class-name
class DecisionTable_Mobx extends React.Component<
  IDecisionTableProps,
  DecisionTableModel
> {
            ...
            <tbody>
              <tr>
                ...
                {this.props.data.columnsVisible.map((columnVisible, cvi) => {
                  ...
                  const toggleClick = () => this.props.data.toggleColumn(cvi);
                  return (
...
export default DecisionTable_Mobx;
